 ...
 */
public class CardNfcAsyncTaskOrg extends AsyncTask<Void, Void, Object>{
    ...
    public static class Builder {
        ...
        public CardNfcAsyncTaskOrg build() {
            return new CardNfcAsyncTaskOrg(this);
        }
    }
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CardNfcAsyncTaskOrg.class);
    ...
    private CardNfcAsyncTaskOrg(Builder b) {
        mTag = b.mTag;
        if (mTag != null) {
